import {HOBBIES, LINKS} from '@/lib/constants';
          ...
          >
            ...
            <Card className="relative h-full flex flex-col sm:flex-row items-start gap-4 p-3 bg-card rounded-xl border-0">
              ...
              <div className="flex-1">
                ...
                <p className="mt-3 text-muted-foreground sm:text-sm md:line-clamp-2 group-hover:line-clamp-none group-focus-within:line-clamp-none transition-all duration-300">
                  {hobby.description}
                </p>
              </div>
            </Card>
